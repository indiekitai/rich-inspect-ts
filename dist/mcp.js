...
import { inspectObject } from './inspect.js';
const server = new McpServer({
    name: 'rich-inspect',
    version: '0.1.0',
});
server.tool('inspect_file', 'Inspect a JSON file or JS module export, returning structured member info', {
...
server.tool('inspect_json', 'Inspect a JSON value directly, returning structured member info', {
